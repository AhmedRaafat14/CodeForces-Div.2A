'''
Vasya works as a DJ in the best Berland nightclub,
...
Vasya inserts a certain number of words "WUB" before the first word of
...
Recently, Petya has heard Vasya's new dubstep track, but since he isn't
into modern music, he decided to find out what was the initial song that
Vasya remixed. Help Petya restore the original song.
=====================================
Input
...
It is guaranteed that before Vasya remixed the song, no word contained
substring "WUB" in it; Vasya didn't change the word order.
...
original_song = mixed_song.replace('WUB', ' ')

print(original_song.strip())
